...
class Progos_Shell_AramexRecordSync extends Mage_Shell_Abstract
{
    /**
     * Run script
     */
    public function run()
    {
        ...
        $obj = new Progos_CustomOrderFlags_Model_Cronaramex();
        echo $obj->syncrecord();
...
$shell = new Progos_Shell_AramexRecordSync();
$shell->run();