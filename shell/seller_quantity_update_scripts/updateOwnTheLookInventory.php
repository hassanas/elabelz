...
class UpdateOwnTheLookInventory extends Mage_Shell_Abstract
{
    public function run()
    {
        ini_set('memory_limit', '-1');
        $configurations = Mage::helper('vendorqtyupdate/config')->getConfigurations('ownthelook');
...
$updateInventory = new UpdateOwnTheLookInventory();
$updateInventory->run();
