...
then
    ...
    echo "Creating origin elastera..."
    git remote add elastera elabelz-stage@manager.elabelz.elastera.net:/git
fi
...
#git rm -r db media var/backups var/export var/import var/report var/log deploy.sh deploy-live.sh ae.elabelz.com
...
git push --force elastera cleanup:master
