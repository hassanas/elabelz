 ...
 *
 */
class Progos_KlevuSearch_Model_CatalogSearch_Resource_Fulltext_Collection extends Klevu_Search_Model_CatalogSearch_Resource_Fulltext_Collection
{
    ...
    public function getFirstFiveProductsParam()
    {
        $this->_klevu_parameters = array(
            'ticket' => Mage::helper('klevu_search/config')->getJsApiKey(),
            'term' => 'open',
    ...
    public function getFirstFiveProducts()
    {
        $resultAll = Mage::getModel('klevu_search/api_action_idsearch')->execute($this->getFirstFiveProductsParam())->getData('result');
//return  $resultAll;
        foreach ($resultAll as $result) {
            ...
            //$this->_klevu_product_ids[$item_id['product_id']] = $item_id['product_id']; // No need to add simple products
        }
        return $this->_klevu_product_ids;
    }
}