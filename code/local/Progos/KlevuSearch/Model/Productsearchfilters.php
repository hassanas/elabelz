...
/**
 * This Module is created for Mobile App search filters
 *
 * @category     Progos
 * @package      Progos_KlevuSearch
 * @copyright    Progos TechCopyright (c) 26-09-2017
 * @author       Hassan Ali Shahzad
 *
 */
class Progos_KlevuSearch_Model_Productsearchfilters extends Klevu_Search_Model_Api_Action
{
    ...
    {
        return $this->execute($this->getProductsParam($args))->getData('filters');
    }
}
