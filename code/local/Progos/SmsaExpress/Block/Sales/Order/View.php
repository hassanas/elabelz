<?php
	class Progos_SmsaExpress_Block_Sales_Order_View extends Mage_Adminhtml_Block_Sales_Order_View
	{
		function __construct()
		{
			...
			elseif(!$_order->canShip() && $smsaexpress_return_button){
				 $this->_addButton('create_smsaexpress_shipment', array(
			...
			if($itemscount==0){				
				$this->_addButton('print_smsaexpress_label', array(
						'label'     => Mage::helper('Sales')->__('SmsaExpress SmsaExpress Label'),
