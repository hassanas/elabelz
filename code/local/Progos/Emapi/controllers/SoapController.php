<?php
/**
 * This Controller is created to handle the SOAP related tasks like creation of sessionIds
 * @category     Progos
...
class Progos_Emapi_SoapController extends Mage_Core_Controller_Front_Action
{
