...
class Progos_Emapi_Model_Cart_Shipping_Api extends Mage_Checkout_Model_Cart_Shipping_Api
{
    public function setShippingMethod($quoteId, $shippingMethod, $store = null)
    {
        ...
        if ($rate === false) {
            Mage::log('error on Progos_Emapi_Model_Cart_Shipping_Api setShippingMethod2.. ' . ' shipping_method_is_not_available \n' . $shippingMethod . '\n', null, 'mobile_app.log');
