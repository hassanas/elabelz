...
class Progos_Api_List_Model_Api2_List_Rest_Guest_V1 extends Progos_Api_List_Model_Api2_List
{
    /**
     *
     * @var int
     ...
     * 
     */
    public function setPageDefaultLimit()
    {
        $this->_limit = Mage::helper('api-list')->getDefaultPageLimit();
    }
    ...
    {
        $this->_limit = is_null($limit) ? $this->_limit : Mage::helper('api-list')->getPageLimit($limit);
    }
    ...
    public function prepareResponse()
    {
        ...
        $cuurencyCode = __($this->_cuurencyCode);
