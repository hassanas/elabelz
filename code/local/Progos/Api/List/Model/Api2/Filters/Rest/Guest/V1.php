...
class Progos_Api_List_Model_Api2_Filters_Rest_Guest_V1 extends Progos_Api_List_Model_Api2_Filters
{  
    ...
    public function prepareLayout()
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            $attributeModelArray[$attribute->getAttributeCode()] = $layerObject;
        }
        $layer->apply();
        foreach ($attributeModelArray as $attributeCode => $layerObject ) {
            $this->addAttributesToFilters($layerObject, $attributeCode);
        }
    }
