...
class Progos_Api_Detail_Model_Api2_Detail_Rest_Guest_V1 extends Progos_Api_Detail_Model_Api2_Detail
{
    protected $_id;
    protected $_sku;
    ...
    protected function _retrieveCollection()
    {
        ...
        Varien_Profiler::start('PRODUCT_DETAIL_loadProduct');
        $this->loadProduct();
        Varien_Profiler::stop('PRODUCT_DETAIL_loadProduct');
