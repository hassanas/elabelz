...
class Progos_NewArrivals_Block_Adminhtml_Expired_Grid extends Mage_Adminhtml_Block_Widget_Grid
{

		public function __construct()
		{
				parent::__construct();
				$this->setId("expiredGrid");
    ...
    {
        $newthreshold = 30;
        $allCatIds = Mage::helper('newarrivals')->getInSaleCategories();
		...
		protected function _prepareColumns()
		{
            ...
            $this->addExportType('*/*/expiredCsv', Mage::helper('newarrivals')->__('CSV'));
            $this->addExportType('*/*/expiredExcel', Mage::helper('newarrivals')->__('Excel'));
