<?php
class Progos_Ecoprocessor_Model_Resource_Quote_Index extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    {
        $this->_init('ecoprocessor/quote_index','id');
    }
    ...
    public function getIdByReserveId($rid)
    {
        ...
        $select = $adapter->select()
            ->from('sales_quote_ecoprocessor', 'id')
