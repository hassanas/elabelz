 ...
 */
class Progos_Xlanding_Model_Search extends Mage_Sitemap_Model_Resource_Catalog_Product
{
	private $_query='';
	...
	public function getCollection($storeId)
	{
		...
		$this->_select = $this->_getWriteAdapter()->select()
				...
				->where("{$this->_alias}.entity_id NOT IN(SELECT product_id FROM am_landing_page_products WHERE page_id={$this->_pageId} ) AND ({$this->_alias}.sku LIKE '{$this->_query}%' OR name_table.value LIKE '%{$this->_query}%') ")
