...
class Progos_Dhl_Model_Dhl extends Infomodus_Dhllabel_Model_Dhl
{
    public $packages;
    public $weightUnits;
    ...
    public function getCustomPaperLessType(){
    ...
    {//$this->shiptoCountryCode
        ...
        $customerPaperlesstype = $this->getCustomPaperLessType();
        $customerPaperStatus = 0;
        if( $customerPaperlesstype ){
            if( $this->shiptoCountryCode == "SA" ){
                $customerPaperStatus = 1;
            }else{
                $customerPaperStatus = Mage::getStoreConfig('dhllabel/paperless/type', $storeId);
            }
        }else{
            $customerPaperStatus = Mage::getStoreConfig('dhllabel/paperless/type', $storeId);
        }
        ...
        if ($this->shipperCountryCode !== "IN" || $this->shiptoCountryCode == "IN") {
            ...
            $localProductCode = ($this->shiptoCountryCode != $this->shipperCountryCode &&
                $customerPaperStatus == 1) ? null : $this->serviceCode;
