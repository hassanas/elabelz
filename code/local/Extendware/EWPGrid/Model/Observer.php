<?php
class Extendware_EWPGrid_Model_Observer
{
        public function updateCommissionTable(Varien_Event_Observer $observer){
            ...
            $i = 0;
                foreach($orderItems as $sItem) {
                    ...
                    if($sItem->getProductType() == "simple")
                    {
                           ...
                           $orderData[$i]['item_price'] =  $sItem->getFinalPrice();
...
//die;
            ...
            if($productId > 0){
                ...
                if($commissionData[0]['id']){
                    ...
                    if($_order['qty_cancelled'] > 0 && $_order['product_id'] == $commissionData[0]['product_id']){
                        ...
                        $commissionFee = $this->calculateCommission($_order['seller_id'],$productPrice);
    ...
    public function calculateCommission($seller_id,$product_price){
