...
class Rewrite_Sales_Model_Order extends Mage_Sales_Model_Order
{
    ...
    public function queueNewOrderEmail($forceMode = false)
    {
        ...
        /* Begin: Reply-to set here */
        $replyTo = (Mage::getModel('core/variable')->loadByCode('add_reply_to_for_new_orders')->getValue('plain')) ? Mage::getModel('core/variable')->loadByCode('add_reply_to_for_new_orders')->getValue('plain') : 'talktous@elabelz.com';
        $mailer->setReplyTo($replyTo);
        /* End: Reply-to set here */
