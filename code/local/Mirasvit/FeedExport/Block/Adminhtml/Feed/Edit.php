...
class Mirasvit_FeedExport_Block_Adminhtml_Feed_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _addButtons()
    {
        ...
        $url = $this->getModel()->getStore()->getUrl(self::URL_PATH_GENERATE);
        $parsedUrl = parse_url($url);
        echo "Sorry for inconvenience, ignore this log, it is generated to diagnose something deep inside the feed generate system";
        echo "<br>";
        echo "### START IGNORING :)";
        echo "<br>";
        echo "-- Before patch";
        ...
        echo "<br>";
        echo "### LOG ENDED, Back to human world!";


        $generateUrl = str_replace('/admin/', '/admin/dashboard/', $generateUrl);
        $stateUrl = $this->_getUrl(self::URL_PATH_STATE);
        $testUrl = $this->_getUrl(self::URL_PATH_TEST, array('id' => $this->getModel()->getId(), 'skip' => 'rules'));
        $testUrl = str_replace('/admin/', '/admin/dashboard/', $testUrl);
