...
class Apptha_CustomMenu_Block_Toggle extends Mage_Core_Block_Template
{
    ...
    public function _prepareLayout()
    {
         ...
         *
         * @return empty
         * Mage::helper('custommenu')->isMobile()
         * 
         */
        $mobDetect    = Mage::helper('mobiledetect');
        $isCustomMenu = Mage::getStoreConfig('custom_menu/general/enabled');
        if (!$isCustomMenu || ( $mobDetect->isMobile() && !$mobDetect->isTablet())) {
            return;
        }
        ...
        if (is_object($topnav)) {
            ...
            $topnav->setTemplate('custommenu/newMenu.phtml');
