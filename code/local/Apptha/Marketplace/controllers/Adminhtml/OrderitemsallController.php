 ...
 */
class Apptha_Marketplace_Adminhtml_OrderitemsallController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Init actions
     *
    ...
    {
        $fileName = 'all-order-items-' . gmdate('Ymd-His') . '.csv';
        if(Mage::getStoreConfig('marketplace/marketplace/export_csv_file') && Mage::helper('marketplace/report')->isApplyFilter()) {
            $this->_prepareDownloadResponse($fileName, Mage::helper('marketplace/report')->generateCsvFile());
        } else {
            $content = $this->getLayout()->createBlock('apptha_marketplace_block_adminhtml_orderitemsall_grid');
    ...
    {
        $fileName = 'all-order-items-' . gmdate('Ymd-His') . '.xls';
        if(Mage::getStoreConfig('marketplace/marketplace/export_excel_file') && Mage::helper('marketplace/report')->isApplyFilter()) {
            $this->_prepareDownloadResponse($fileName, Mage::helper('marketplace/report')->generateExcelFile());
        } else {
            $content = $this->getLayout()->createBlock('apptha_marketplace_block_adminhtml_orderitemsall_grid');
