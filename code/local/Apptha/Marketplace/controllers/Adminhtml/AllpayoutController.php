 ...
 */
class Apptha_Marketplace_Adminhtml_AllpayoutController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Init actions
     *
    ...
    public function editAction()
    {
        ...
        $this->_addContent(
            $this->getLayout()->createBlock('marketplace/adminhtml_allpayout_edit')
        );
        ...
        if ($this->getRequest()->getParam('id') > 0) {
            ...
            try {
                ...
                */
                ...
                $this->_redirect('marketplaceadmin/adminhtml_allpayout/index/');
            } catch (Exception $e) {
                /**
                 * Display Error message
                 */
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                $this->_redirect('marketplaceadmin/adminhtml_allpayout/edit/payout_status/pending/id/' . $id);
            }
        }
        ...
        if ($this->getRequest()->getParam('id') > 0) {
            ...
            try {
                ...
                */
                 ...
                 */
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                $this->_redirect('marketplaceadmin/adminhtml_allpayout/edit/payout_status/approve/id/' . $id);
            }
        }
        ...
        if ($this->getRequest()->getParam('id') > 0) {
            ...
            try {
                ...
                */
                 ...
                 */
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                $this->_redirect('marketplaceadmin/adminhtml_allpayout/edit/payout_status/disapprove/id/' . $id);
            }
        }
    ...
    public function paidAction()
    {
        if ($this->getRequest()->getParam('id') > 0) {
            ...
            try {
                 ...
                 */
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                $this->_redirect('marketplaceadmin/adminhtml_allpayout/edit/payout_status/paid/id/' . $id);
            }
        }
