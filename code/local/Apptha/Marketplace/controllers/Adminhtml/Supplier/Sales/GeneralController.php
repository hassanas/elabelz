...
/**
 * Class Apptha_Marketplace_Adminhtml_Supplier_Sales_GeneralController
 */
class Apptha_Marketplace_Adminhtml_Supplier_Sales_GeneralController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Init actions
     *
    ...
    public function statusAction()
    {
        ...
        if ($value == "Yes") {
            $comment = "<strong>Order Item is Confirmed</strong> via Call Center";
        } elseif ($value == "No") {
            $comment = "<strong>Order Item is set as Pending</strong> via Call Center";
        } else {
            $comment = "<strong>Order Item is Rejected</strong> via Call Center";
        }
        try {
            $order->addStatusHistoryComment($comment, $order->getStatus())
                ->setIsVisibleOnFront(0)
