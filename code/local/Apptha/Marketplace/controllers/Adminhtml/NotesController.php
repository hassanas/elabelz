 ...
 */
class Apptha_Marketplace_Adminhtml_NotesController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Init actions
     *
    ...
    public function editAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('marketplace/adminhtml_orderitemsall_edit'));
