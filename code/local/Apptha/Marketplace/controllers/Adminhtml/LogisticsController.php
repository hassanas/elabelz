 ...
 */
class Apptha_Marketplace_Adminhtml_LogisticsController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Init actions
     *
    ...
    public function exportCsvAction()
    {
        ...
        $content = $this->getLayout()->createBlock('apptha_marketplace_block_adminhtml_logistics_grid');
