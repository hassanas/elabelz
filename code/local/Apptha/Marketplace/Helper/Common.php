...
class Apptha_Marketplace_Helper_Common extends Mage_Core_Helper_Abstract {
    ...
    /**
     * Function to delete a seller order item from marketplace_commission table 
     *
     * @param int $marketplaceId
     *            This function will return true or false
     * @return bool
    ...
    public function deleteSellerOrder($marketplaceId) {
    ...
    /**
     * Check if customer has payment track record
     */
    public function haveCompletedOrdersBefore($customerId)
    {
        ...
        if($order->getId() > 0) {
            //customer has previously completed an order
            return true;
        }
        return false;
    }

    public function paidViaCreditCard($paymentCode)
    {
        return (strpos($paymentCode, "cc") !== false) ? true : false;
    }
