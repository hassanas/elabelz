 ...
 */
class Apptha_Marketplace_Block_Category_View extends Mage_Core_Block_Template
{
    ...
    public function getCurrentCategory()
    {
        ...
        $_category = $this->getRequest ()->getParam ('category_name');
        if (!$this->hasData('current_category')) {
            
            $this->setData('current_category', Mage::registry($_category));
        }
