...
class Apptha_Marketplace_Block_Adminhtml_Ordersrefundhistory_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    
    public function __construct() {
        parent::__construct ();
        $this->setId ( 'ordersrefundhistoryGrid' );
    ...
    protected function _prepareCollection() {
        ...
        ->addFieldToFilter ( 'refund_request_customer', [['eq' => 1],['eq' => 0]])
    ...
    protected function _prepareColumns() {
        ...
        $seller_confirmation = array (
            'header' => Mage::helper ( 'sales' )->__ ( 'Seller<br>Confirmated' ),
            'align' => 'center',
            'width' => '100',
            'filter' => false,
            'sortable' => false,
            'index' => 'id',
            'is_system' => true,
            'renderer' => 'Apptha_Marketplace_Block_Adminhtml_Renderersource_RefundRequestSellerConfirmation' 
        );
        $this->addColumn ( 'refund_request_seller_confirmation', $seller_confirmation );

        // add column
        $buyer_confirmation = array (
            'header' => Mage::helper ( 'sales' )->__ ( 'Buyer<br>Request' ),
            'width' => '100',
            'align' => 'center',
            'filter' => false,
            'sortable' => false,
            'index' => 'id',
            'is_system' => true,
            'renderer' => 'Apptha_Marketplace_Block_Adminhtml_Renderersource_RefundRequestCustomer' 
        );
        $this->addColumn ( 'refund_request_customer', $buyer_confirmation );        
        ...
        $this->addColumn ( 'refund', array (
            ...
            'actions' => array (
                array (
                    'caption' => Mage::helper ( 'marketplace' )->__ ( 'Refund' ),
                    'url' => array (
                            'base' => 'adminhtml/sales_order_creditmemo/start/' 
                    ),
                    'field' => 'order_id' 
                ) 
            ),
    ...
    public function getRowUrl($row) {
        return $this->getUrl ( 'adminhtml/sales_order_creditmemo/start/', array (
