 ...
 * Get Order Details
 */
class Apptha_Marketplace_Block_Adminhtml_Allpayout extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function __construct() {
        $this->_controller = 'adminhtml_allpayout';
        $this->_blockGroup = 'marketplace';
        $this->_headerText = Mage::helper('marketplace')->__('Seller Payout Request');
