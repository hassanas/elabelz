 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Orderitemsall_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
 ...
 public function __construct() {
  ...
  $this->_objectId = 'id';
  $sellBuyText = 'marketplace';
  $adminhtmlManageseller = 'adminhtml_orderitemsall';
  $this->_blockGroup = $sellBuyText;
  $this->_controller = $adminhtmlManageseller;
  $this->_addButton('back', array(
          'label'   => Mage::helper('adminhtml')->__('Back'),
          'onclick' => 'setLocation(\'' . Mage::helper('adminhtml')->getUrl('*/adminhtml_orderitemsall/index/'). '\')',
          'class'   => 'back',
          'level'   => -1
  ));
 }
