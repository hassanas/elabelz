 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Orderitemsall extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function __construct() {
       ...
       //  $this->_removeButton('add');
         $this->_controller = 'adminhtml_orderitemsall';
        $this->_blockGroup = 'marketplace';
        $this->_headerText = Mage::helper('marketplace')->__('All Order Items');
        $this->_addButtonLabel = Mage::helper('marketplace')->__('Add Item');
        parent::__construct();
        $this->_removeButton('add');
    }
