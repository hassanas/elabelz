...
class Apptha_Marketplace_Block_Adminhtml_Renderersource_Payment extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        foreach ( $id as $_id ) {
            ...
            /*-------------------Start Edit by Azhar Farooq Redirect to user on Withdraw request Page*/
            $result = "<a href='" . $this->getUrl ( 'marketplaceadmin/adminhtml_order/payout/', array (
                        'id' => $_id 
                ) ) . "' title='" . Mage::helper ( 'marketplace' )->__ ( 'click to Go' ) . "'>" . Mage::helper ( 'marketplace' )->__ ( 'View Payout Requests' ) . "</a>";
