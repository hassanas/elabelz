 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Renderersource_Logistics_ProductSku extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        // foreach($commission as $com):
            $sku = Mage::getModel('catalog/product')->load($value);
            $sku = $sku->getSku();
            $orderDetails .= "<li>".$sku."</li>" ;
            $orderCsv = $sku;
        // endforeach;
        $orderDetails .= "</ul>";
