...
class Apptha_Marketplace_Block_Adminhtml_Renderersource_GetIsBuyerConfirmedCancelRequest extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        if ($item->getCancelRequestCustomer() == 1) {
