 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Renderersource_Manager_Ordercount_AwaitingForSeller extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
     ...
     * @return int
     */
    public function render(Varien_Object $row) {    #AwaitingForSeller
