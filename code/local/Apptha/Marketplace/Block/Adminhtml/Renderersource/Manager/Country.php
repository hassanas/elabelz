 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Renderersource_Manager_Country extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $address->getSelect()->distinct(true);
        $orderids = array();
              foreach($address as $ad){
                array_push($orderids, $ad->getCountryId());
              }
              $orderids = array_unique($orderids);
        return $country_name=Mage::app()->getLocale()->getCountryTranslation($orderids[0]); 
        }
}
