 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Renderersource_Sellerdetails extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        if ($customer->getId()) {
            ...
            return $store_title ."<br>".$additional_details;
        } else {
            return "N/A";
        }
    }
