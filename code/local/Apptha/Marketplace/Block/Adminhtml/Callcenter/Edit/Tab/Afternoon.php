...
class Apptha_Marketplace_Block_Adminhtml_Callcenter_Edit_Tab_Afternoon extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct ();
        $this->setId ( 'callcenterafternoonGrid' );
    ...
    protected function _prepareCollection()
    {
        ...
        foreach($orders as $order) {
            ...
            if (empty($order->getSession()) && $order_session == "Afternoon") {
                $order->setSession("Afternoon");
                $order->save();
            ...
            // if (($order_session == "Morning") && ($order->getSession() == "morning" OR is_null($order->getSession() ) ) ) {
    ...
    {
       return $this->getUrl('*/*/afternoon', array('_current'=>true));
    }
