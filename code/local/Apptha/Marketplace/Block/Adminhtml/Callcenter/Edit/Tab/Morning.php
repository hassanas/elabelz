...
class Apptha_Marketplace_Block_Adminhtml_Callcenter_Edit_Tab_Morning extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct ();
        $this->setId ( 'callcentermorningGrid' );
    ...
    protected function _prepareCollection()
    {
        ...
        foreach($orders as $order) {
            ...
            if (empty($order->getSession()) && $order_session == "Morning") {
                $order->setSession("Morning");
                $order->save();
                $finalIdx[] = $order->getIncrementId();
            } elseif ($order->getSession() == "Morning") {
                $finalIdx[] = $order->getIncrementId();
            }
    ...
    {
       return $this->getUrl('*/*/morning', array('_current'=>true));
    }
