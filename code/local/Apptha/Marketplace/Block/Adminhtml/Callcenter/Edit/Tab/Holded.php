...
class Apptha_Marketplace_Block_Adminhtml_Callcenter_Edit_Tab_Holded extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct ();
        $this->setId ( 'callcenterholdedGrid' );
    ...
    protected function _prepareCollection()
    {
        ...
        $orders = Mage::getModel("sales/order")->getCollection()
            ...
            ->addFieldToFilter("status", array("eq"=>"holded"))
    ...
    {
       return $this->getUrl('*/*/onhold', array('_current'=>true));
    }
