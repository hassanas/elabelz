...
class Apptha_Marketplace_Block_Adminhtml_Callcenter_Edit_Tab_Plus extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct ();
        $this->setId ( 'callcenterplusGrid' );
    ...
    {
       return $this->getUrl('*/*/plus', array('_current'=>true));
    }
