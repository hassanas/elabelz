...
class Apptha_Marketplace_Block_Adminhtml_Unconfirmedfromseller_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        // ->addFieldToFilter(array('is_seller_confirmation', 'is_buyer_confirmation'), array(
        //     array("eq"=>'No'),
        //     array("eq"=>'No')
        // ))
        // ->setOrder ( 'created_at', 'DESC' )
        // ->setOrder ( 'order_id', 'DESC' );
        // $orders->getSelect()->where("is_seller_confirmation = 'No' OR is_buyer_confirmation = 'No'");
    ...
    protected function _prepareColumns() {
        ...
        $seller_confirmation = array (
            'header' => Mage::helper ( 'sales' )->__ ( 'Seller Confirmationss' ),
            'align' => 'center',
            'width' => '100',
            'path' => 'unconfirmed_from_seller',
            'filter' => false,
            'index' => 'id', 
