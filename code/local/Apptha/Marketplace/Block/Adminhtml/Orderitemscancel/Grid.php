...
class Apptha_Marketplace_Block_Adminhtml_Orderitemscancel_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    
    public function __construct() {
        parent::__construct ();
        $this->setId ( 'cancelorderitemsGrid' );
    ...
    protected function _prepareCollection() {
        ...
        ->addFieldToFilter ( 'item_order_status', array (
            'in' => ['canceled', 'canceled_automatic']
        ))
    ...
    protected function _prepareColumns() {
        ...
        $orderStatus = array (
            ...
            'options' => array(
                ...
                "closed"                        => "Closed",
                "canceled"                      => "Canceled",
                "canceled_automatic"            => "Canceled-Automatic",
            )
        );
