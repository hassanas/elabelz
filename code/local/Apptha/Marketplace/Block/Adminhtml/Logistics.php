 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Logistics extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function __construct() {
       ...
       // // parent::__construct();
        ...
        $this->_controller = 'adminhtml_logistics';
        $this->_blockGroup = 'marketplace';
        $this->_headerText = Mage::helper('marketplace')->__('Supplier Screen');
        parent::__construct();
