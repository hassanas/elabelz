 ...
 */
class Apptha_Marketplace_Block_Adminhtml_Allpayout_Grid extends Mage_Adminhtml_Block_Widget_Grid {
        ...
        $this->addColumn ( 'action', array (
                ...
                'actions' => array (
                        array (
                                ...
                                'url' => array (
                                'base' => 'marketplaceadmin/adminhtml_allpayout/edit',
                                'params' => array('payout_status'=>'pending')
                                        ),
                                'field' => 'id',
                        ...
                        array (
                                ...
                                'url' => array (
                                'base' => 'marketplaceadmin/adminhtml_allpayout/edit',
                                'params'=>array('payout_status'=>'approve')
                                        ),
                                'field' => 'id',
                                'confirm' => Mage::helper ( 'marketplace' )->__ ( 'Are you sure?' )
                        ),
                        array (
                                ...
                                'url' => array (
                                'base' => 'marketplaceadmin/adminhtml_allpayout/edit',
                                'params'=>array('payout_status'=>'disapprove')
                                        ),
                                'field' => 'id',
                                'confirm' => Mage::helper ( 'marketplace' )->__ ( 'Are you sure?' ) 
                        ),
                        array (
                                ...
                                'url' => array (
                                'base' => 'marketplaceadmin/adminhtml_allpayout/edit',
                                'params'=>array('payout_status'=>'paid')
                                        ),
                                'field' => 'id',
                                'confirm' => Mage::helper ( 'marketplace' )->__ ( 'Are you sure?' ) 
                        )
