 ...
 */
class Apptha_Marketplace_Block_Adminhtml_AllPayout_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
 ...
 public function __construct() {
  ...
  $this->_addButton('back', array(
          ...
          'onclick' => 'setLocation(\'' . Mage::helper('adminhtml')->getUrl('*/adminhtml_allpayout/index/'). '\')',
          'class'   => 'back',
          'level'   => -1
  ));
 ...
 public function getHeaderText() {
  ...
  $collections = Mage::getModel('marketplace/payout')->load($payout_id,'id');
  $seller_id  = $collections->getSeller_id();
