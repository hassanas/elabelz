 ...
 */
class Apptha_Marketplace_Block_Payout extends Mage_Core_Block_Template {
    /**
    ...
    public function getHistory() {
        ...
        return Mage::getModel('marketplace/payout')->getCollection()->addFieldToFilter('seller_id', $customerId)->setOrder('id', 'DESC');
    }

    public function getAcknowledge($payoutId) {
        /**
         * Return order acknowledge url
         */
        return Mage::getUrl('marketplace/seller/payoutacknowledge', array('payout_id' => $payoutId));
    }
    ...
    public function getTransactions(){
        ...
        //return $this->getLayout()->createBlock('marketplace/Transation')->getFunctionName();
         /**
         * Get customer
         */
        $customer = Mage::getSingleton("customer/session")->getCustomer();
