    ...
    public function dispatch()
    {
        switch ($this->getActionType() . $this->getOperation()) {
            ...
            case self::ACTION_TYPE_ENTITY . self::OPERATION_RETRIEVE:
                ...
                Mage::dispatchEvent('api_retrieve_data_before', array('object' => $this , 'operation' => 'retrieve' ));
                $retrievedData = $this->getData();
                if(Mage::registry('api_rest_request_for_skip_authentication')) {
                    $this->getResponse()->setMimeType('application/json')
                            ->setBody(Mage::getModel('api2/renderer_json')->render($retrievedData));
                } else {
            ...
            case self::ACTION_TYPE_COLLECTION . self::OPERATION_RETRIEVE:
                ...
                Mage::dispatchEvent('api_retrieve_data_before', array('object' => $this , 'operation' => 'collection'));
                $retrievedData = $this->getData();
                if(Mage::registry('api_rest_request_for_skip_authentication')) {
                    $this->getResponse()->setMimeType('application/json')
                            ->setBody(Mage::getModel('api2/renderer_json')->render($retrievedData));
