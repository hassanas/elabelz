 ...
 */
class Fetchr_Shipping_Helper_Tracker extends Mage_Core_Helper_Abstract{
    ...
    public function pushOrderAfterShipmentCreation($shipment,$shipment_created)
    {
        ...
        if($orderStatus['order_status']  == 'Order Is Pushed'):
            $orderStatus['order_status'] = 'Order Not Found';
        endif;
