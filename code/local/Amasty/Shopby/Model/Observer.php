...
class Amasty_Shopby_Model_Observer
{
    ...
    public function handleLayoutRender()
    {
        ...
        $container->setData('products', Mage::getSingleton('catalog/layer')->getProductCollection()->getSize());
        $container->setData('title', $headBlock ? $headBlock->getTitle() : null);
        $container->setData('sortby_data', Mage::app()->getLayout()->createBlock('catalog/product_list_toolbar')->setData('category_default_sortby',Mage::getSingleton('core/session')->getMyValue())->setTemplate('catalog/product/list/sortby_list.phtml')->toHtml());
