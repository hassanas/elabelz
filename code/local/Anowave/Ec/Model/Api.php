...
class Anowave_Ec_Model_Api
{
	 ...
	 */
	private function getAdwordsConversionId()
	{
		if ('' == Mage::getStoreConfig('ec/api/google_adwords_conversion_id'))
		{
			return 0;
		}
		
		return Mage::getStoreConfig('ec/api/google_adwords_conversion_id');
	}
	
	/**
	 * Get safe conversion label
	 */
	private function getAdwordsConversionLabel()
	{
		if ('' == Mage::getStoreConfig('ec/api/google_adwords_conversion_label'))
		{
			return 0;
		}
		
		return Mage::getStoreConfig('ec/api/google_adwords_conversion_label');
	}
}