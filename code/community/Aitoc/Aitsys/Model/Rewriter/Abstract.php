...
abstract class Aitoc_Aitsys_Model_Rewriter_Abstract extends Aitoc_Aitsys_Abstract_Model
{
    ...
    static public function getRewritesCacheDir()
    {
        ...
        //echo "+++++" . Mage::getModuleDir('', 'Aitoc_Aitsys') . self::REWRITE_CACHE_DIR;
        return Mage::getModuleDir('', 'Aitoc_Aitsys') . self::REWRITE_CACHE_DIR;//was writing files inside var which was creating problems
    }
