...
class Varien_Profiler
{
    ...
    public static function getConfiguration()
    {
        if (is_null(self::$_configuration)) {
            ...
            $file = BP . DIRECTORY_SEPARATOR . 'app' .DIRECTORY_SEPARATOR . 'code'.DIRECTORY_SEPARATOR . 'community'.DIRECTORY_SEPARATOR . 'Aoe'. DIRECTORY_SEPARATOR . 'Profiler' .DIRECTORY_SEPARATOR . 'aoe_profiler.xml';
            if (is_file($file)) {
    ...
    public static function isEnabled()
    {
        ...
        if ((!self::$_checkedEnabled && strtolower($conf->trigger) == 'parameter' && isset($_GET['profile']) && $_GET['profile'] == true )) {
        ...
        elseif ((self::$_checkedEnabled && strtolower($conf->trigger) == 'parameter' && isset($_GET['profile']) && $_GET['profile'] == true )) {
            return self::$_enabled;
        }
        else {
         return false;
