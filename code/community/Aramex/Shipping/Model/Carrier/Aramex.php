...
class Aramex_Shipping_Model_Carrier_Aramex extends Mage_Usa_Model_Shipping_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {
    ...
    function __construct() {
        ...
        $this->_defaultGatewayUrl = Mage::helper('aramexshipment')->getWsdlPath($storeId) . 'Tracking.wsdl';
    }
    ...
    public function setRequest(Mage_Shipping_Model_Rate_Request $request) {
        ...
        if ($request->getOrigPostcode()) {
            ...
            $storeId = Mage::app()->getStore()->getStoreId();
            $r->setOrigPostal(Mage::getStoreConfig('shipping/origin/postcode', $storeId));
        }
    ...
    public function _getAramexQuotes() {
        ...
        $storeId = Mage::app()->getStore()->getStoreId();
        if (Mage::getStoreConfig('aramexsettings/shipperdetail/country', $storeId) == $r->getDestCountryId()) {
            $product_group = 'DOM';
