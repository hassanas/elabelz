...
class Magidev_Sort_Block_Adminhtml_Catalog_Category_Tab_Sort extends Mage_Core_Block_Template
{
	...
	private function _prepareProducts()
	{
		...
		$collection
				...
				//->addAttributeToSelect('*'); /* This line is commented by Ahmed Javed as it was loading all the product attribites which doesn't makes any sense, in future if this commented code turned out to be creating an issue then please add the only attributes which are required do not use asteric (*) */
