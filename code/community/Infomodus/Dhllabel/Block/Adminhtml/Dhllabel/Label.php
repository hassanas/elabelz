...
class Infomodus_Dhllabel_Block_Adminhtml_Dhllabel_Label extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('dhllabel_data') && Mage::registry('dhllabel_data')->getId() ) {
            return Mage::helper('dhllabel')->__("Label '%s'", $this->htmlEscape(Mage::registry('dhllabel_data')->getTitle()));
        } else {
