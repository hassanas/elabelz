 ...
 * @package BoxPacker
 */
class Infomodus_Dhllabel_Model_Packer_PackedBox
{
     ...
     */
    public function __construct(Infomodus_Dhllabel_Model_Packer_Box $box, Infomodus_Dhllabel_Model_Packer_ItemList $itemList, $remainingWidth, $remainingLength, $remainingDepth, $remainingWeight)
    {
        $this->box = $box;
        $this->items = $itemList;
