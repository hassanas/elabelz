 ...
 * @package BoxPacker
 */
class Infomodus_Dhllabel_Model_Packer_WeightRedistributor
{
    /**
     ...
     * Constructor
     */
    public function __construct(Infomodus_Dhllabel_Model_Packer_BoxList $boxList)
    {
     ...
     */
    public function redistributeWeight(Infomodus_Dhllabel_Model_Packer_PackedBoxList $originalBoxes)
    {
            ...
            foreach ($underWeightBoxes as $u => $underWeightBox) {
                ...
                foreach ($overWeightBoxes as $o => $overWeightBox) {
                    ...
                    foreach ($overWeightBoxItems as $oi => $overWeightBoxItem) {
                        ...
                        $newLighterBoxPacker = new Infomodus_Dhllabel_Model_Packer_Packer(); //we may need a bigger box
                        ...
                        if ($newLighterBox->getItems()->count() === $newItemsForLighterBox->count()) { //new item fits
                            ...
                            $newHeavierBoxPacker = new Infomodus_Dhllabel_Model_Packer_Packer(); //we may be able to use a smaller box
