 ...
 * @package BoxPacker
 */
class Infomodus_Upslabel_Model_Packer_PackedBox
{
     ...
     */
    public function __construct(Infomodus_Upslabel_Model_Packer_Box $box, Infomodus_Upslabel_Model_Packer_ItemList $itemList, $remainingWidth, $remainingLength, $remainingDepth, $remainingWeight)
    {
        $this->box = $box;
        $this->items = $itemList;
