...
class Infomodus_Upslabel_Adminhtml_Upslabel_ConformityController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->_addBreadcrumb(Mage::helper('upslabel')->__('UPS Method Conformity Manager'), Mage::helper('upslabel')->__('UPS Method Conformity Manager'));
            $this->_addBreadcrumb(Mage::helper('upslabel')->__('UPS Method Conformity News'), Mage::helper('upslabel')->__('UPS Method Conformity News'));
